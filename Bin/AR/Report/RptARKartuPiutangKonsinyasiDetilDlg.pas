unit RptARKartuPiutangKonsinyasiDetilDlg;
...
type
  TfmARRptKartupiutangDetilKonsinyasiDlg = class(TfmRptDlg)
    GroupBox1: TGroupBox;
    dt1: TdxDateEdit;
    rbAll: TRadioButton;
...
var
  fmARRptKartupiutangDetilKonsinyasiDlg: TfmARRptKartupiutangDetilKonsinyasiDlg;

implementation

uses StdLv0, QRRptAPKartuHutang, UnitGeneral, QRRptAPKartuHutangDetil,
  QRRptAPKartuHutangKonsinyasiDetil, ARQRRptKartuPiutangKonsinyasiDetil,
  Search;

{$R *.dfm}

procedure TfmARRptKartupiutangDetilKonsinyasiDlg.rbAllClick(Sender: TObject);
begin
  inherited;
...
procedure TfmARRptKartupiutangDetilKonsinyasiDlg.FormShow(Sender: TObject);
begin
  inherited;
  quAct.Open;        
  dt1.Date:=date;
...
procedure TfmARRptKartupiutangDetilKonsinyasiDlg.bbPreviewClick(Sender: TObject);
begin
  inherited;
   with TfmARQRRptKartuPiutangKonsinyasiDetil.Create(Self) do
  try
    tglDari:=dt1.Date;
...
procedure TfmARRptKartupiutangDetilKonsinyasiDlg.bbCancelClick(
  Sender: TObject);
begin
  inherited;
