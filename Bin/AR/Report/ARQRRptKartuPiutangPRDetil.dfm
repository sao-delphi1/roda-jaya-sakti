inherited fmARQRRptKartuPiutangPRDetil: TfmARQRRptKartuPiutangPRDetil
  Left = 15
  Top = 127
  Width = 1000
  HorzScrollBar.Position = 85
  Caption = 'fmARQRRptKartuPiutangPRDetil'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited qu003: TADOQuery
    SQL.Strings = (
      ''
      ' Select B.CustId,B.CurrId,B.ReturnRepId,Convert(varchar(20),'
      'B.TransDate,103) as Tanggal, isnull(B.TTLreturRep,0) As TTLPI '
  ...
  object qu004: TADOQuery
    ...
    SQL.Strings = (
      ...
      'isnull(ValuePayment,0) as Amount FROM ARTrPayReturnrepDt A'
      ' INNER JOIN ARTrPenggantiReturPenjHd C '
      'ON A.ReturnRepId=C.ReturnrepId INNER JOIN '
      'ARTrPayReturnrepHd B ON A.PayReturnRepId=B.PayReturnrepId ')
    Left = 316
    Top = 116
  end
end
