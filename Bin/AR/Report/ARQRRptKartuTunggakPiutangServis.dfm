inherited fmARQRRptKartuTunggakPiutangServis: TfmARQRRptKartuTunggakPiutangServis
  Left = 2
  Top = 73
  Width = 1000
  HorzScrollBar.Position = 85
  Caption = 'fmARQRRptKartuTunggakPiutangServis'
  PixelsPerInch = 96
  TextHeight = 13
  inherited MyReport: TQuickRep
    ...
    object SummaryBand1: TQRBand
      ...
      object QRLabel11: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = 'GRAND TOTAL TUNGGAKAN PIUTANG SERVICE  :'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
  ...
  inherited qu002: TADOQuery
    SQL.Strings = (
      ...
      'M.CustID,Convert(varchar(20),K.TransDate,103) as Tanggal, '
      'K.InvServiceID as IP, isnull(K.TTLSV,0) as Kredit, '
      
        '(select isnull(sum(L.ValuePayment),0) FROM ARTrPiutInvServiceDt ' +
        'L '
      'where L.InvServiceID = K.InvServiceID) as Debit FROM '
      'ARTrInvServiceHd K INNER JOIN ARTrServiceHd M ON '
      'K.ServiceId=M.ServiceID ')
    Top = 68
  end
