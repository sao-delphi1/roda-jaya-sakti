...
procedure TfmARRptReturPjDlg.KodeDariButtonClick(Sender: TObject;
...
begin
  ...
  with TfmSearch.Create(Self) do
    try
       Title := 'Pelanggan';
       SQLString := 'SELECT CustName as Nama_Pelanggan,CustId as Kode_Pelanggan,City as Kota FROM ARMsCustomer ORDER BY CustID';
...
procedure TfmARRptReturPjDlg.dxButton1Click(Sender: TObject);
begin
  inherited;
  with TfmSearch.Create(Self) do
    try
