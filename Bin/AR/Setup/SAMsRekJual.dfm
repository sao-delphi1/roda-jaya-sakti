inherited fmSAMsRekJual: TfmSAMsRekJual
  ...
  inherited paLeft: TdxContainer
    ...
    inherited pa3: TdxContainer
      ...
      object Label1: TLabel
        ...
        Width = 174
        Height = 13
        Caption = 'Disarankan menggunakan 16-bitmap'
      end
    ...
    inherited pcParent: TdxPageControl
      ...
      inherited ts01: TdxTabSheet
        object dbgUOM: TdxDBGrid [0]
          ...
          PreviewFont.Style = []
          object dbgUOMColumn3: TdxDBGridColumn
            Caption = 'ID'
            Width = 50
            BandIndex = 0
            RowIndex = 0
          ...
          object dbgUOMColumn7: TdxDBGridColumn
            Width = 150
            BandIndex = 0
            RowIndex = 0
            FieldName = 'Cabang'
          end
          object dbgUOMColumn8: TdxDBGridImageColumn
  ...
  inherited quMain: TADOQuery
    ...
    SQL.Strings = (
      'select * from samsrekjual')
    object quMainRekJualID: TStringField
      FieldName = 'RekJualID'
      Size = 50
    end
    ...
    object quMainnamattd: TStringField
      FieldName = 'namattd'
      Size = 50
    end
  end
