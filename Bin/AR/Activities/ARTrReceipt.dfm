inherited fmARTrReceipt: TfmARTrReceipt
  Left = 558
  Top = 224
    ...
    inherited pcParent: TdxPageControl
      ...
      inherited ts01: TdxTabSheet
        ...
        object dxDBGrid1: TdxDBGrid
          ...
          object dxDBGrid1ItemName: TdxDBGridButtonColumn
            ...
            OnButtonClick = dxDBGrid1ItemNameButtonClick
          end
          object dxDBGrid1Value: TdxDBGridColumn
            Caption = 'Jumlah'
            Width = 150
            BandIndex = 0
            RowIndex = 0
  ...
  inherited quDetil: TADOQuery
    ...
    SQL.Strings = (
      'select * from artrreceiptdt where riid=:riid')
  ...
  object quTotal: TADOQuery
    ...
    SQL.Strings = (
      'Select SUM(Amount) as Total From ARtrReceiptDt Where RIID=:RIID')
    Left = 456
    Top = 269
