inherited fmAROtoSalesInv: TfmAROtoSalesInv
  Left = 591
  Top = 180
  Caption = 'Otorisasi Sales Invoice'
  ClientHeight = 499
  ClientWidth = 962
  OnCreate = FormCreate
  PixelsPerInch = 96
  ...
  inherited quAct: TADOQuery
    SQL.Strings = (
        ...
        'Select A.TransDate,A.KonInvPelID,A.SaleID,B.CustName,A.Note,C.Si' +
        'teName From ARTrKonInvPelHd A'
  ...
  object quDetil: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select A.KonInvPelID,A.NoUnit,A.ItemName as Note ,A.Qty,A.UOMID,' +
        'A.Price,B.Description as ItemName'
