...
begin
  inherited;
  CeKStatus;
  DeleteFromAllItem(quMainServiceID.Value,10,1,'');
  DeleteFromAllItem(quMainServiceID.Value,61,1,'');
 // CeKRetur;
...
begin
  inherited;
  CeKStatus;
  DeleteFromAllItem(quMainServiceID.Value,quDetilItemID.Value,10,1);
 // CeKRetur;
...
begin
  ...
  InsertToAllItem(quDetilServiceID.Value,quMainTransDate.value,quMainWareHouseID.Value,quDetilItemID.Value
                  ,10,abs(qudetilqty.Value),0,'AP',quMainLcustName.Value,'-',1);
