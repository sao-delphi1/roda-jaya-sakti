    ...
    try
      ...
      Begin
        ...
        add('select A.POID as POID,A.POID as POIDD,CONVERT(varchar(10),A.TglKirim,103) as TglKirim,C.SiteName as SiteID, '
           ...
           +'left join samspt d on a.warehouseid=d.kodept '
