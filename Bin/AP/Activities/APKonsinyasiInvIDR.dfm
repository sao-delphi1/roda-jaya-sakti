inherited fmAPKonsinyasiInvIDR: TfmAPKonsinyasiInvIDR
  ...
  inherited pa2: TdxContainer [4]
    Height = 676
  end
  inherited pcMain: TdxPageControl [5]
    Width = 1030
    Height = 676
  ...
  inherited paBottom: TdxContainer [6]
    Top = 713
    Width = 1223
  end
  ...
  inherited quMain: TADOQuery
    ...
    object quMainBiayaMaterial: TBCDField
      FieldName = 'BiayaMaterial'
      DisplayFormat = '#,0'
      Precision = 18
    end
  ...
  object quTotal: TADOQuery
    ...
    SQL.Strings = (
        ...
        'K.Total+K.TotalU)*K.Disc/100,0))*(K.NilaiTax/100) '
      ...
      ''
        ...
        'D((K.Total+K.TotalU)*K.Disc/100,0))*(K.NilaiTax/100)'
        ...
        'gPPh26='#39'Y'#39' THEN K.PPH26 ELSE 0 END))+K.BiayaMaterial as GT'
      'FROM ('
      ''
      
        'select A.KonsinyasiInvID,A.POID,B.FgTax,B.Disc,C.Payment,c.biaya' +
        'material,'
      ...
      'WHEN A.FgPPH='#39'26'#39' THEN (A.Qty*A.Price*(1-B.Disc/100)*20/100)'
        ...
        'e*(1-B.Disc/100)*2.5/100 ELSE A.Qty*A.Price*(1-B.Disc/100)*3/100' +
        ' END) '
      ...
      ''
      'C.FGpph21,C.FGpph23,C.Fgpph15,C.FgPPh26,C.NilaiTax'
      ...
      ''
        ...
        'ph23,C.Payment,C.FgPPh15,C.FgPPh26,c.biayamaterial,C.NilaiTax'
      ''
      ') as K WHERE K.KonsinyasiInvID=:KonsinyasiInvID'
      'group by K.KonsinyasiInvID,K.Payment,k.biayamaterial')
    Left = 668
    Top = 400
