  ...
  object quTotal: TADOQuery
    ...
    SQL.Strings = (
      ...
      'ROUND(X.SubTotalU,0) as SubtotalU,'
        ...
        'Total*X.Disc/100),0) END)*(X.NilaiTax/100),0) '
        ...
        '*X.Disc/100),0) END)*0.011,0) ELSE 0 END as Pajak,'
        ...
        'bTotal*X.Disc/100),0) END)*(X.NilaiTax/100),0)'
      
        'WHEN X.FgTax='#39'E'#39' THEN ROUND((CASE WHEN X.DiscType='#39'A'#39' THEN ROUND' +
        '(X.Subtotal,0)-X.Disc ELSE ROUND(X.SubTotal,0)-ROUND((X.SubTotal' +
        '*X.Disc/100),0) END)*0.011,0) ELSE 0 END) as Total,'
      ''
        ...
        'WHEN X.FgTax='#39'E'#39' THEN ROUND((CASE WHEN X.DiscType='#39'A'#39' THEN ROUND' +
        '(X.Subtotal,0)-X.Disc ELSE ROUND(X.SubTotal,0)-ROUND((X.SubTotal' +
        '*X.Disc/100),0) END)*0.011,0) ELSE 0 END)-'
      ...
      'ROUND(X.PPh42,0)-ROUND(X.PPh26,0)-X.PT+X.BiayaMaterial as GT'
      'FROM ('
      ''
      ''
      ...
      ''
        ...
        'ELSE A.Price*A.Qty*(1-B.Disc/100)*50/100*3/100 END) ELSE 0 END) ' +
      ...
      ''
        ...
        'ND),0) as PPh15,'
      ''
      'B.DiscType,B.Disc,B.FgTax,b.BiayaMaterial,B.NilaiTax'
      ...
      'WHERE B.PurchaseId=:PurchaseID'
        ...
        'h23,B.DiscCashamount,B.FgPPh15,B.FgPPh26 ,b.BiayaMaterial,B.Nila' +
        'iTax'
      ''
      ''
      ') as X')
