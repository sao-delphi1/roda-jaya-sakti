inherited fmAPQRRptKartuHutangKonsinyasiDetil: TfmAPQRRptKartuHutangKonsinyasiDetil
  Left = 205
  Top = 156
  Width = 1000
  Caption = 'fmAPQRRptKartuHutangKonsinyasiDetil'
  PixelsPerInch = 96
  TextHeight = 13
  inherited MyReport: TQuickRep
    ...
    object SummaryBand1: TQRBand
      ...
      object QRLabel11: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = 'GRAND TOTAL HUTANG KONSINYASI IDR  :'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
      ...
      object QRLabel10: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = 'GRAND TOTAL HUTANG KONSINYASI USD :'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
  ...
  inherited qu003: TADOQuery
    SQL.Strings = (
      ''
      ' Select B.CustId,B.CurrId,B.KonsinyasiInvId,Convert(varchar(20),'
      'B.TransDate,103) as Tanggal, isnull(B.TTLKS,0) As TTLPI '
  ...
  object qu004: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'Select A.KonsinyasiInvId,B.PaymentKonsID,'
      'Convert(varchar(20),B.TransDate,103) as Tanggal, '
      'isnull(ValuePayment,0) as Amount FROM APTrPaymentKonsDt A '
      'INNER JOIN APTrKonsinyasiInvHd C ON '
      'A.KonsinyasiInvId=C.KonsinyasiInvId INNER JOIN '
      'APTrPaymentKonsHd B ON A.PaymentKonsID=B.PaymentKonsID ')
    Left = 404
    Top = 100
  end
end
