inherited fmCFRptJurnal: TfmCFRptJurnal
  Left = 249
  Top = 335
  ...
  inherited quAct: TADOQuery
    SQL.Strings = (
        ...
        'select '#39'2021/01/01'#39' as Tanggal,'#39'VOUCHER/01/01/01/01'#39' as VoucherN' +
        'o,'
      
        #39'history jurnal rekening versi export excel dengan keterangan aa' +
        'aaaaaaaaaaaaaaaaaa'
      'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
      'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
      'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
      
        'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'#39' as Keterangan,'#39'aaaaaaaaaa' +
        'aaaaaaaaaaaaaaaaa'#39' as rekeningid,'
      
        #39'asdasdasdjasdjashdsadhjasdadhsajdhsadj'#39' as rekeningname,3123123' +
        '2131233213.00 as jumD,'
      '1323432484389483.00 as jumK')
    object quActTanggal: TStringField
      FieldName = 'Tanggal'
      ReadOnly = True
      Size = 10
    end
    object quActVoucherNo: TStringField
      FieldName = 'VoucherNo'
      ReadOnly = True
      Size = 19
    end
