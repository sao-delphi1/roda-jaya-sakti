inherited fmCFRptFPS: TfmCFRptFPS
  Left = 251
  Top = 197
  Caption = 'Rekap Faktur Pajak'
  ClientHeight = 474
  ClientWidth = 1318
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited quMain: TADOQuery
    SQL.Strings = (
      'select * from ('
        ...
        'select A.Transdate,A.KonsinyasiInvID,C.POID,B.SuppName,C.Subtota' +
        'lM+C.SubtotalU as  SubTotal,A.Ongkir,A.PBBKB,C.DiscAmount as Dis' +
        'c,C.PPN,C.TTLKJ as TTLKS,A.FPS,A.transdate as tglFPS from APTrKo' +
        'nsinyasiInvSub C'
      
        'inner join APTrKonsinyasiInvHd A on A.KonsinyasiInvID=C.Konsinya' +
        'siInvID'
      ''
      ...
      'UNION ALL'
        ...
        'select A.TransDate,A.PurchaseID,'#39#39',B.SuppName,A.StPb,0,0,A.DiscA' +
        'mount,A.PPN,A.TTLPb,A.POID,A.tglFPS from APTrPurchaseHd A inner ' +
        'join APMsSupplier B on A.SuppID=B.SuppID'
      'where A.PPN<>0 AND A.FgPajak='#39'Y'#39
      ') as K')
