...
begin
  ...
  with TfmCFQRRptKeuanganDetBank.Create(Self) do
     ...
     Begin
       Close;Clear;
       Add('SELECT DISTINCT K.RekeningID,K.RekeningID+'' - ''+L.RekeningName as Rek,L.RekeningName,L.FgTipe,L.Tipe,L.CurrID FROM ('
          ...
          +'SELECT B.RekeningID,A.Transdate FROM CFTrKKBBHd A INNER JOIN CFMsBank B ON A.BankID=B.BankID WHERE A.FgPayment=''T'' AND FlagKKBB IN (''BM'',''BK'',''KK'',''KM'') UNION ALL '
          //penjualan
          +'SELECT RekeningU,Transdate FROM ARTrKonInvPelHd UNION ALL '
          +'SELECT RekeningP,Transdate FROM ARTrKonInvPelHd UNION ALL '
          +'SELECT RekeningK,Transdate FROM ARTrKonInvPelHd UNION ALL '
          +'SELECT RekeningA,Transdate FROM ARTrKonInvPelHd UNION ALL '
          +'SELECT RekeningO,Transdate FROM ARTrKonInvPelHd UNION ALL '
          +'SELECT RekeningR,Transdate FROM ARTrKonInvPelHd UNION ALL '
          +'SELECT RekeningD,Transdate FROM ARTrKonInvPelHd UNION ALL '
          +'SELECT RekeningHpp,Transdate FROM ARTrKonInvPelHd UNION ALL '
          +'SELECT RekeningPsd,Transdate FROM ARTrKonInvPelHd UNION ALL '
          //pembelian
          +'SELECT RekeningU,Transdate FROM ApTrkonsinyasiInvhD Where FgOto=''Y'' UNION ALL '
          +'SELECT RekPBBKB,Transdate FROM ApTrkonsinyasiInvhD Where FgOto=''Y'' UNION ALL '
          +'SELECT RekeningP,Transdate FROM ApTrkonsinyasiInvhD Where FgOto=''Y'' UNION ALL '
          +'SELECT RekeningK,Transdate FROM ApTrkonsinyasiInvhD Where FgOto=''Y'' UNION ALL '
          +'SELECT RekeningDP,TransDate FROM ApTrkonsinyasiInvhD Where FgOto=''Y'' UNION ALL '
          +'SELECT RekeningA,Transdate FROM ApTrkonsinyasiInvhD Where FgOto=''Y'' UNION ALL '
          +'SELECT RekeningO,TransDate FROM ApTrkonsinyasiInvhD Where FgOto=''Y'' UNION ALL '
          +'SELECT RekeningR,Transdate FROM ApTrkonsinyasiInvhD Where FgOto=''Y'' UNION ALL '
          +'SELECT RekeningJ,Transdate FROM ApTrkonsinyasiInvhD Where FgOto=''Y'' UNION ALL '
          +'SELECT RekeningD,Transdate FROM ApTrkonsinyasiInvhD Where FgOto=''Y'' UNION ALL '
          //pembelian
          +'SELECT RekeningU,Transdate FROM ApTrPurchaseHD Where FgOto=''Y'' AND FgPajak=''Y'' UNION ALL '
          +'SELECT RekeningP,Transdate FROM ApTrPurchaseHD Where FgOto=''Y'' AND FgPajak=''Y'' UNION ALL '
          +'SELECT RekeningK,Transdate FROM ApTrPurchaseHD Where FgOto=''Y'' AND FgPajak=''Y'' UNION ALL '
          +'SELECT RekeningJ,Transdate FROM ApTrPurchaseHD Where FgOto=''Y'' AND FgPajak=''Y'' UNION ALL '
          +'SELECT RekeningD,Transdate FROM ApTrPurchaseHD Where FgOto=''Y''AND FgPajak=''Y'' '
