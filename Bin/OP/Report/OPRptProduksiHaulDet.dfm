inherited fmOPRptProduksiHaulDet: TfmOPRptProduksiHaulDet
  Left = 244
  Top = 126
  Caption = 'Laporan Produksi Hauler Detail'
  ClientHeight = 487
  ClientWidth = 1083
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited quAct: TADOQuery
    ...
    object quActDigger: TStringField
      FieldName = 'Digger'
      Size = 50
    end
    object quActHslProduksi: TStringField
      FieldName = 'HslProduksi'
      Size = 255
    end
    object quActArea: TStringField
      FieldName = 'Area'
      Size = 255
    end
    object quActDriverH: TStringField
      FieldName = 'DriverH'
      Size = 50
    end
    object quActDriverD: TStringField
      FieldName = 'DriverD'
      Size = 50
    end
